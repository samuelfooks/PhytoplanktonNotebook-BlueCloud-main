...
# %%
def get_PhytoHotspot(geodata, depth, hotspot_concentration, zarr_filepath='phytoplankton/soca_chla_01_12.zarr'):
...
MPAs = gpd.read_file('/home/samwork/Documents/coding/PhytoplanktonNotebook-BlueCloud-main/data/MPAs/WDPA_WDOECM_May2024_Public_marine_shp/WDPA_WDOECM_May2024_Public_marine_shp_2/WDPA_WDOECM_May2024_Public_marine_shp-polygons.shp')
...
map_instance.save_to_html(file_name='phyto_map_all_months_MPAs_dots.html')
